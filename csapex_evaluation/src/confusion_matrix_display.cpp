...
ConfusionMatrixDisplay::ConfusionMatrixDisplay() : connector_(nullptr)
{
}

void ConfusionMatrixDisplay::setupParameters(Parameterizable& params)
{
    params.addParameter(csapex::param::factory::declareText("filename", csapex::param::ParameterDescription("Name of csv file"), "conf_mat"), filename_);

    params.addParameter(csapex::param::factory::declareDirectoryOutputPath("path", csapex::param::ParameterDescription("Directory to write file to"), "", ""), path_);

    params.addParameter(param::factory::declareTrigger("save csv file"), [this](param::Parameter*) { save(); });
}
