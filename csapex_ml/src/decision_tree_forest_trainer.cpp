...
DecisionTreeForestTrainer::DecisionTreeForestTrainer() : rand_vec_(2), classes_(0)
{
}
...
void DecisionTreeForestTrainer::setupParameters(Parameterizable& parameters)
{
    ...
    parameters.addParameter(csapex::param::factory::declareBool("classes/one-vs-all", false), one_vs_all_);
    ...
    parameters.addParameter(csapex::param::factory::declareRange<int>("dforest/classes", csapex::param::ParameterDescription("Number of classes to learn."), 0, 100, 2, 1),
                            std::bind(&DecisionTreeForestTrainer::updatePriors, this));
    ;

    parameters.addParameter(csapex::param::factory::declareFileOutputPath("dforest/file", "dforest.yaml"), path_);
    ...
    parameters.addParameter(csapex::param::factory::declareRange<int>("max depth",
                            ...
                            max_depth_);
    ;
    parameters.addParameter(csapex::param::factory::declareRange<int>("dforest/min_sample_count",
                                                                      ...
                                                                      0, 64, 10, 1),
                            min_sample_count_);
    parameters.addParameter(csapex::param::factory::declareRange<double>("dforest/regression_accuracy",
    ...
    ;
    parameters.addParameter(csapex::param::factory::declareBool("dforest/use_surrogates",
                            ...
                            use_surrogates_);
    ;
    parameters.addParameter(csapex::param::factory::declareRange<int>("dforest/max_categories",
                            ...
                            max_categories_);
    ;
    parameters.addParameter(csapex::param::factory::declareRange<int>("dforest/cv_folds",
                            ...
                            cv_folds_);
    ;
    parameters.addParameter(csapex::param::factory::declareBool("dforest/use_1se_rule",
                            ...
                            use_1se_rule_);
    ;
    parameters.addParameter(csapex::param::factory::declareBool("dforest/truncate_pruned_tree",
...
//    int tflag = cv::ml::ROW_SAMPLE;
    ...
    if (one_vs_all_) {
        ...
        for (std::size_t i = 0; i < indices_by_label.size(); ++i) {
            ...
            /// now we gather negative samples, which is basically collecting all the
            /// other classes
