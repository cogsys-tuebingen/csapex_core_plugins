...
void GradientBoostedTreesTrainer::setupParameters(Parameterizable &parameters)
{
    ...
    parameters.addParameter(param::ParameterFactory::declareRange<int>("gb/weak_count",
    ...
    parameters.addParameter(param::ParameterFactory::declareParameterSet("gb/loss_function_type",
                                                                         param::ParameterDescription("Loss function used for ensemble training."),
                                                                         loss_function_type,
                                                                         (int) params_.loss_function_type));
    parameters.addParameter(param::ParameterFactory::declareRange<float>("gb/subsample_portion",
                                                                         param::ParameterDescription("Portion of whole training set used for \n"
                                                                                                     ...
                                                                                                     "step is computed as."),
                                                                         0.01f, 1.0f, params_.subsample_portion, 0.01f),
                            params_.subsample_portion);
    parameters.addParameter(param::ParameterFactory::declareRange<float>("gb/shrinkage",
                                                                         param::ParameterDescription("A regularization parameter.\n"
                                                                                                     "Each tree prediction is multiplied on shrinkage value."),
                                                                         0.01f, 1.0f, params_.shrinkage, 0.01f),
                            params_.shrinkage);
    ...
    parameters.addParameter(param::ParameterFactory::declareRange<float>
                           ("dtree/regression_accuracy",
                            ...
                            0.0f, 255.0f, params_.regression_accuracy, 0.01f),
                            params_.regression_accuracy);;
