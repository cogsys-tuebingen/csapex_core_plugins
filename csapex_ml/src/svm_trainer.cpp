...
void SVMTrainer::setupParameters(Parameterizable& parameters)
{
    ...
    parameters.addParameter(param::factory::declareBool("svm/save_coeffs",
    ...
    parameters.addConditionalParameter(param::factory::declareRange<double>("degree", 0.0, 9.0, 3.0, 1.0),
                                       deg_cond,
                                       degree_);
    parameters.addConditionalParameter(param::factory::declareRange<double>("gamma", 0.0, 10.0, 0.0, 0.01),
                                       gamma_cond,
                                       gamma_);
    parameters.addConditionalParameter(param::factory::declareRange<double>("coef0", -10.0, 10.0, 0.0, 0.01),
                                       coeff0_cond,
                                       coef0_);
    parameters.addConditionalParameter(param::factory::declareRange<double>("C", 0.0, 10.0, 0.01, 0.01),
                                       c_cond,
                                       C_);
    parameters.addConditionalParameter(param::factory::declareRange<double>("nu", 0.0, 1.0, 0.5, 0.01),
                                       nu_cond,
                                       nu_);
    parameters.addConditionalParameter(csapex::param::factory::declareRange<double>("p", 0.0, 1.0, 0.1, 0.01),
                                       p_cond,
                                       p_);
}
