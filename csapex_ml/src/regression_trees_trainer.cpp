...
//    params.addParameter(param::);
    ...
    params.addParameter(csapex::param::factory::declareRange<int>
                        ("max depth",
    ...
    params.addParameter(csapex::param::factory::declareRange<int>
                        ("min sample count",
                         ...
                         0, 64, 10, 1));
    params.addParameter(csapex::param::factory::declareRange<double>
                        ("regression accuracy",
    ...
    params.addParameter(csapex::param::factory::declareBool
                        ("use surrogates",
