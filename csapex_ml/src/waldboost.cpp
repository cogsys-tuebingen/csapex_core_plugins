...
WaldBoost::WaldBoost() : loaded_(false)
{
}
...
{
    parameters.addParameter(param::factory::declarePath("/waldboost/path", csapex::param::ParameterDescription("Path to a saved svm."), true, "", "*.yaml *.tar.gz"), path_);
}
