...
{
    parameters.addParameter(csapex::param::factory::declareTrigger("submit", csapex::param::ParameterDescription("Continue with the current labeling")), std::bind(&ScanLabeler::submit, this));

    addParameter(csapex::param::factory::declareBool("automatic", csapex::param::ParameterDescription("Automatically continue without user interaction"), false));
