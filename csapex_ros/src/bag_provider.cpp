...
BagProvider::BagProvider() : pub_setup_(false), has_last_tf_time_(false), view_all_(nullptr), initiated(false), end_signaled_(false)
{
    ...
    csapex::param::Parameter::Ptr topic_param = csapex::param::factory::declareParameterStringSet("topic", csapex::param::ParameterDescription("topic to play <b>primarily</b>"), set, "");
