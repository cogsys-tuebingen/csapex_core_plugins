...
void Row::process()
{
    ...
    param::RangeParameter::Ptr range = getParameter<param::RangeParameter>("row");
...
{
    addParameter(csapex::param::factory::declareRange("row", csapex::param::ParameterDescription("Row to extract."), 0, 1, 0, 1));
    parameters.addParameter(csapex::param::factory::declareTrigger("center"), std::bind(&Row::requestCenter, this));
}
