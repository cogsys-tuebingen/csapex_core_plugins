...
{
    parameters.addParameter(csapex::param::factory::declareRange("border", 0, 1000, 0, 1));
    parameters.addParameter(csapex::param::factory::declareRange("mask offset", 0, 100, 0, 1));
    parameters.addParameter(csapex::param::factory::declareColorParameter("color", 0x00, 0x00, 0x00));
}
