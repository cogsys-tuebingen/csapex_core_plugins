...
{
    parameters.addParameter(csapex::param::factory::declareRange("size width", 1, 10000, 640, 1),
                            std::bind(&Resize::update, this));
    parameters.addParameter(csapex::param::factory::declareRange("size height", 1, 10000, 480, 1),
                            std::bind(&Resize::update, this));
