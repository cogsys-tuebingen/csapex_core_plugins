...
void testWrapDirect(const cv::Mat& input, int flipcode, cv::Mat& output)
{
...
void RegisterPlugin::init(CsApexCore& core)
{
    ...
    auto cWrap = GenericNodeFactory::createConstructorFromFunction<ParameterInfoTestWrap>(testWrap, "TestWrap");
    ...
    auto cWrapDirect = GenericNodeFactory::createConstructorFromFunction<ParameterInfoTestWrap>(testWrapDirect, "TestWrapDirect");
    ...
    auto cWrapDirectNoInfo = GenericNodeFactory::createConstructorFromFunction(testWrapDirect, "TestWrapDirectNoInfo");
