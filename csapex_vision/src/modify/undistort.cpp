...
{
    parameters.addParameter(csapex::param::factory::declareBool("load from file", param::ParameterDescription("Load a calibration from a .yaml file."), true), std::bind(&Undistort::update, this));
    ...
    parameters.addConditionalParameter(csapex::param::factory::declareFileInputPath("file", param::ParameterDescription("Path to .yaml calibration file."), "", "*.yaml"), load_from_file,
                                       std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("fx", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("fy", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("cx", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("cy", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("k1", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("k2", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("k3", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("k4", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("k5", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("k6", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("p1", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
    parameters.addConditionalParameter(csapex::param::factory::declareValue("p2", 0.0), do_not_load_from_file, std::bind(&Undistort::update, this));
