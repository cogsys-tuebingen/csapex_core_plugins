...
void Sobel::setupParameters(Parameterizable& parameters)
{
    ...
    parameters.addParameter(csapex::param::factory::declareRange("dx", 0, 5, dx_, 1), std::bind(&Sobel::update, this));
    parameters.addParameter(csapex::param::factory::declareRange("dy", 0, 5, dy_, 1), std::bind(&Sobel::update, this));
}
