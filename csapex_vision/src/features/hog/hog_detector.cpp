...
void HOGDetector::setupParameters(Parameterizable& parameters)
{
    ...
    parameters.addParameter(csapex::param::factory::declareRange("svm/thresh", -10000.0, 10000.0, 0.0, 0.1),
                            svm_thresh_);
    ...
    parameters.addConditionalParameter(param::factory::declareBool("svm/load_threshold", true),
                                       custom_active, std::bind(&HOGDetector::load, this));
    ...
    parameters.addParameter(param::factory::declareParameterSet("hog/scan_mode", scan_modes, (int) SINGLE_SCALE),
                            scan_mode_);

    parameters.addParameter(param::factory::declareRange("hog/levels",
