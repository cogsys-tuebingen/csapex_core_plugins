...
{
    parameters.addParameter(param::factory::declareRange("bins", 1, 18, 9, 1), bins_);
    ...
    parameters.addParameter(param::factory::declareBool("invert order", true), invert_order_);
}
