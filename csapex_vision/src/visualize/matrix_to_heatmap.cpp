...
MatrixToHeatmap::MatrixToHeatmap() : color_type_(BEZIER)
{
}
...
{
    std::map<std::string, int> types = { { "BEZIER", (int)BEZIER }, { "PARABOLA", (int)PARABOLA } };
    parameters.addParameter(csapex::param::factory::declareParameterSet<int>("coloring", types, (int)BEZIER), std::bind(&MatrixToHeatmap::update, this));
}
