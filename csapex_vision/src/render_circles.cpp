...
public:
    ...
    void setupParameters(csapex::Parameterizable& params) override
    {
        ...
        //            width_ = p->as<int>();
        //        });
        params.addParameter(param::factory::declareRange("line_thickness",1,10,1,1),
                            thickness_);

        params.addParameter(param::factory::declareBool("different_colors",false),
                            diff_colors_);

        params.addConditionalParameter(param::factory::declareColorParameter("color",255,0,0),
                                       [this](){return ! diff_colors_;},
        [this](param::Parameter* p){
