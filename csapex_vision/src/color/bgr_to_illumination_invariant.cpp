...
public:
    ...
    virtual void process() override
    {
        ...
        //labels : 0 unaltered, 1 invalid, 2 capped (or 2 for min capped 3 for max capped)
        ...
        case Newman:
        {
            ...
            //Max= 0.5 + log(255) - alpha*log(b) - log(r) + alpha*log(r) = 0.5 + log(255)   (alpha,b,r = 0)
            //Min= 0.5 + log(1) - alpha*log(b) - log(r) + alpha*log(r) = 0.5 - log(255) (alpha=1,b=255, r=0)
            ...
            for(std::size_t i = 0 ; i < size ; ++i) {
                ...
                std::tie(dst[i], mask[i]) = get_thresholded(i); //threshold min/max vals
        ...
        case Santos:
        {
            ...
            //psi_1,2 = U x chi_r,g,b                 psi_1:max/min = +/- (1/sqrt(2)*log(255)), psi_2:max/min = +/- (2/sqrt(6)*log(255))
            //I = psi_1*cos(theta)+psi_2*sin(theta)   max/min = +/- (log(255)*(1/2+1/sqrt(3))
...
//                    dst[i] = 128;
    ...
    virtual void setupParameters(Parameterizable &parameters)
    {
        ...
        parameters.addConditionalParameter(param::factory::declareInterval("threshold range", param::ParameterDescription("Valid and acceptable range"),0,100,0,100,1),
                                           k_cond,
