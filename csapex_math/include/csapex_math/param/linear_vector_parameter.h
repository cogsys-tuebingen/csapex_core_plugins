...
namespace param
{
class CSAPEX_PARAM_EXPORT LinearVectorParameter : public ParameterTemplate<math::linear::Vector, LinearVectorParameter>
{
public:
...
public:
    ...
    explicit LinearVectorParameter(const std::string& name, const ParameterDescription& description, math::linear::Vector value);
};

template <>
CSAPEX_MATH_EXPORT inline std::string serializationName<LinearVectorParameter>()
{
