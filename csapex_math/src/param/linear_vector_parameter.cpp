...
LinearVectorParameter::LinearVectorParameter(const std::string& name, const ParameterDescription& description, math::linear::Vector value)
  : ParameterTemplate(name, description, value)
{
}
