...
public:
    ...
    {
        return VariadicInputs::createVariadicInput(multi_type::make<GenericVectorMessage, GenericValueMessage<int>, GenericValueMessage<double>>(), label.empty() ? "Vector<Number> or Number" : label,
