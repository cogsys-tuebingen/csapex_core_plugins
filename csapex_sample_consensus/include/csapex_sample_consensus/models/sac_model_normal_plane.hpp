...
NormalPlane<PointT, NormalT>::NormalPlane(const typename PointCloud::ConstPtr &pointcloud,
...
{
    NormalPlane<PointT, NormalT> *plane =
            new NormalPlane<PointT, NormalT>(Base::pointcloud_,
                                                  Base::normalcloud_,
