...
void ClusterBoundaryMask::process()
{
    ...
    case CV_8UC1:
        utils_vision::getClusterBoundaryMask<uint8_t>(in->value, out->value);
        break;
    case CV_8SC1:
        utils_vision::getClusterBoundaryMask<int8_t>(in->value, out->value);
        break;
    case CV_16UC1:
        utils_vision::getClusterBoundaryMask<uint16_t>(in->value, out->value);
        break;
    case CV_16SC1:
        utils_vision::getClusterBoundaryMask<int16_t>(in->value, out->value);
        break;
    case CV_32SC1:
        utils_vision::getClusterBoundaryMask<int32_t>(in->value, out->value);
        break;
    default:
