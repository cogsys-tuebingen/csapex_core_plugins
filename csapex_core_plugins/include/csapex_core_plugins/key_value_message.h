...
{
struct CSAPEX_CORE_LIB_EXPORT KeyValueMessage : public MessageTemplate<std::pair<std::string, TokenData::ConstPtr>, KeyValueMessage>
{
public:
...
// KeyValueMessage& t); const SerializationBuffer& operator >> (const
// SerializationBuffer& data, KeyValueMessage& t);
