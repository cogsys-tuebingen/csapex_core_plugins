...
{
public:
    CountMessagesInVectors() : input_(nullptr), output_(nullptr), reset_(nullptr), count_(0)
    {
    }
    ...
    {
        connection_types::GenericVectorMessage::ConstPtr vector = msg::getMessage<connection_types::GenericVectorMessage>(input_);
