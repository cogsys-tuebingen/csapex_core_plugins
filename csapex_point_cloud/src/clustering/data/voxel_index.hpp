...
public:
    ...
    constexpr VoxelIndex(float size_x, float size_y, float size_z) : voxel_size_{ size_x, size_y, size_z }
    {
    }
    ...
    {
        return { { static_cast<int>(point.x / voxel_size_[0]), static_cast<int>(point.y / voxel_size_[1]), static_cast<int>(point.z / voxel_size_[2]) } };
    }
