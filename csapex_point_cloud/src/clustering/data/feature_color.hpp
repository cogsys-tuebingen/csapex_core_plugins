...
public:
    ...
    inline double difference(const DifferenceFunction& difference_fn,
                             const std::array<double, 3>& weights,
                             const ColorFeature& other) const
    {
...
private:
    ...
    {
        Difference(const DifferenceFunction& difference_fn,
                   const std::array<double, 3>& weights) :
                difference_fn_(difference_fn), weights(weights)
        {}
