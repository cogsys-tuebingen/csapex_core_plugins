...
public:
    ...
    void setupParameters(Parameterizable& parameters)
    {
        ...
        parameters.addParameter(param::factory::declareRange("min height", -5.0, 5.0, 0.0, 0.01), min_height_);

        parameters.addParameter(param::factory::declareRange("distance factor", 0.0, 1.0, 1.0, 0.001), distance_factor_);
    }
    ...
    template <class PointT>
    void filter(const pcl::PointCloud<PointT>& in, pcl::PointCloud<PointT>& out)
    {
        out = in;
