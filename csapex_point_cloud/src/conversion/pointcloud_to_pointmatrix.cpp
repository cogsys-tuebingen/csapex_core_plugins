...
struct Impl {
    static void convert(const typename pcl::PointCloud<PointT>::ConstPtr cloud,
                        CvMatMessage::Ptr &matrix,
...
struct Impl<pcl::PointXY> {
    static void convert(const typename pcl::PointCloud<pcl::PointXY>::ConstPtr cloud,
                        CvMatMessage::Ptr &matrix,
                        CvMatMessage::Ptr &mask)
    {
...
struct Impl<pcl::PointXYZI> {
    static void convert(const typename pcl::PointCloud<pcl::PointXYZI>::ConstPtr cloud,
                        CvMatMessage::Ptr &matrix,
                        CvMatMessage::Ptr &mask)
    {
...
struct Impl<pcl::PointXYZRGB> {
    static void convert(const typename pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr cloud,
                        CvMatMessage::Ptr &matrix,
                        CvMatMessage::Ptr &mask)
    {
