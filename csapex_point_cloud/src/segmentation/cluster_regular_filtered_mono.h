#ifndef CLUSTERREGULARFILTEREDMONO_H
#define CLUSTERREGULARFILTEREDMONO_H
...
class ClusterRegularFilteredMono : public csapex::Node
{
public:
...
private:
    ...
    ClusterParamsStatisticalMono cluster_params_;
};
}

#endif // CLUSTERREGULARFILTEREDMONO_H
