...
class RoiGenerator : public Node
{
public:
    RoiGenerator()
    {
    ...
    void process()
    {
        ...
        boost::apply_visitor (PointCloudMessage::Dispatch<RoiGenerator>(this, cloud), cloud->value);
    }
...
CSAPEX_REGISTER_CLASS(csapex::RoiGenerator, csapex::Node)
