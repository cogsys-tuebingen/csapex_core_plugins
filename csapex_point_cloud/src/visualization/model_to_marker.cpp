...
{
    // visualization_msgs::MarkerArray::Ptr marker_array(new
    // visualization_msgs::MarkerArray); visualization_msgs::Marker marker;
    ...
    // Change to marker array so that a nicer cone can be displayed by a vector
    // and a circle
}
