...
PointCountAdapter::PointCountAdapter(NodeFacadeImplementationPtr worker, NodeBox* parent, std::weak_ptr<PointCount> node) : DefaultNodeAdapter(worker, parent), wrapped_(node)
{
