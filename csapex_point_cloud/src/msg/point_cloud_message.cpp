...
Token::Ptr PointCloudMessage::clone() const
{
...
Token::Ptr PointCloudMessage::toType() const
{
...
bool PointCloudMessage::acceptsConnectionFrom(const Token* other_side) const
{
