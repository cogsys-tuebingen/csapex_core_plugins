...
public:
    ...
    inline void getEigenValues(EigenValueSetType& _eigen_values, const double _abs = false) const
    {
        if (n_1 >= 2) {
            if (dirty)
                update();
    ...
    inline double sample(const PointType& _p, PointType& _q) const
    {
        if (n_1 >= 2) {
            if (dirty)
                update();
    ...
    inline double sampleNonNormalized(const PointType& _p, PointType& _q) const
    {
        if (n_1 >= 2) {
            if (dirty)
                update();
