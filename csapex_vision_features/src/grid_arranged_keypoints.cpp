...
public:
    ...
    void setupParameters(Parameterizable& parameters) override
    {
        ...
        parameters.addConditionalParameter(csapex::param::ParameterFactory::declareRange("class id", -1, 255, -1, 1), cond_adv);
        parameters.addConditionalParameter(csapex::param::ParameterFactory::declareRange("octave", 0, 12, 0, 1), cond_adv);
        parameters.addConditionalParameter(csapex::param::ParameterFactory::declareRange("response", 0, 12, 0, 1), cond_adv);
        parameters.addConditionalParameter(csapex::param::ParameterFactory::declareRange("angle", -1.0, 2 * M_PI, -1.0, 0.1), cond_adv);
    }
