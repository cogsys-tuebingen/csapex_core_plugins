...
public:
    ...
    //getter
    inline std::size_t problemDimension() const {return problem_dim_;}
    inline bool boundsSetted() const {return set_bounds_;}
    inline std::vector<double> getStartParams() const {return start_values_;}
