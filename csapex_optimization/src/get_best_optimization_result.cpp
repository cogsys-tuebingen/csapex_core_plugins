...
public:
    ...
    void setup(csapex::NodeModifier& modifier) override
    {
        ...
        in_ = modifier.addSlot<GenericValueMessage<double>>("fitness", [this](const TokenPtr& data) { fitnessCb(data); });

        in_params_ = modifier.addSlot<GenericVectorMessage, double>("parameter", [this](const TokenPtr& msg) { paramCb(msg); });
    ...
    void setupParameters(csapex::Parameterizable& params) override
    {
        ...
        params.addParameter(param::factory::declareTrigger("get_best"), [this](param::Parameter*) {
            ...
            str << "It is expected to have the same number of fitness values and "
                   "paramter messages."
